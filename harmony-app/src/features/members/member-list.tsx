    ...
    return (
      <div className="flex h-full flex-col bg-default-100">
        <div className="flex flex-1 flex-col items-center justify-center gap-2 px-4">
          ...
          <p className="text-center text-sm text-default-500">Select a server to view members</p>
        </div>
      </div>
    )
  }
  ...
  if (isError) {
    return (
      <div className="flex h-full flex-col bg-default-100">
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-2 px-4">
          <Users className="h-10 w-10 text-default-300" />
          <p className="text-center text-sm text-danger">Failed to load members</p>
        </div>
      </div>
    )
  }
      ...
      <div className="flex-1 overflow-y-auto px-2 py-2">
        ...
        {members.length === 0 && (
          <div className="flex flex-1 flex-col items-center justify-center gap-2 px-4 py-8">
            <Users className="h-10 w-10 text-default-300" />
            <p className="text-center text-sm text-default-500">No members yet</p>
          </div>
        )}
      </div>
    </div>
